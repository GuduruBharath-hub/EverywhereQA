...
export default function VerifiedLab() {
  return <main className="lab-page">
    <header className={`${navStyles.header} lab-header`}><a href="/">← Everywhere QA</a><span>Verified repair fixture</span><a className={navStyles.switch} href="/lab-broken">← View broken</a></header>
